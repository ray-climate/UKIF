# TsHARP SPEI Downscaling — France Delivery Package

Downscale a 1 km SPEI drought map to **10 m** using Sentinel-2 NDVI via the TsHARP method.

## Region

**France** (mainland), bounding box: lon [-5.5, 9.5], lat [41.0, 51.5]
...
> **Model performance:** The XGBoost model was trained on GMID SPEI-1 (2020–2024). Test R² = 0.71, RMSE = 0.47. Per-year validation vs GMID: 2020 r=0.80, 2021 r=0.76, 2022 r=0.89, 2023 r=0.85, 2024 r=0.77. 3-fold CV: R²=0.71.
